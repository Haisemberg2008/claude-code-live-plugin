...
Plugin local para coordenar tarefas do Claude Code a partir do Codex com planejamento aprovado, responsáveis explícitos, permissões mínimas, acompanhamento ao vivo e retomada controlada.
